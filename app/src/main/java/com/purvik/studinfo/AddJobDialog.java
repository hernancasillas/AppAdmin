...
public class AddJobDialog extends DialogFragment {
    ...
    interface AddJobDialogListener{

        void onAddButtonClick(DialogFragment dialog);
        //void onCancelButtonClick(DialogFragment dialog);

    }

    //create an Instance to deliever the action
    AddJobDialogListener addJobListener;
    Context context;
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            addJobListener = (AddJobDialogListener) activity;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(inflater.inflate(R.layout.activity_add_job_dialog, null))

                // Add action buttons
                .setPositiveButton(R.string.add, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int id) {
                        addJobListener.onAddButtonClick(AddJobDialog.this);
                    }
                })
